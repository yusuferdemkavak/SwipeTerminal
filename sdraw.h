...
// Objects //
void DrawPoint(DPoint d_point); // Draws a Point on the window
void DrawLine(DLine d_line); // Draws a Line on the window
void DrawTriangle(DTriangle d_triangle); // Draws a Triangle on the window
void DrawRectangle(DRectangle d_rectangle); // Draws a Rectangle on the window
void DrawCircle(DCircle d_circle); // Draws a Circle on the window

//-----Drawable Converters-----//
DPoint DrawablePoint(Point point, Color color); // Returns  DPoint from a Point and drawing properties
DLine DrawableLine(Line line, Color color); // Returns a DLine from a Line and drawing properties
